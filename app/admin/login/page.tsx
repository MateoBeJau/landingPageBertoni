...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left panel - branding */}
      <div className="lg:w-1/2 bg-linear-to-br from-stone-950 to-stone-900 flex flex-col items-center justify-center px-8 py-12 lg:py-0">
        <div className="flex flex-col items-center text-center max-w-sm">
          ...
          <p className="mt-2 text-sm lg:text-base text-stone-400">
            Plataforma de gestão para fotógrafos profissionais
          </p>
        </div>
      </div>
